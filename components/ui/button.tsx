...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-base font-semibold transition-all disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive",
  {
    variants: {
      variant: {
        default:
          'bg-primary text-primary-foreground shadow-lg hover:bg-brand-600 hover:scale-[1.02] active:scale-[0.98] hover:shadow-xl',
        secondary:
          'bg-surface-100 text-surface-900 hover:bg-surface-200 border border-surface-200',
        accent:
          'bg-accent text-accent-foreground hover:bg-accent-600 shadow-lg hover:scale-[1.02] active:scale-[0.98] hover:shadow-xl',
        outline:
          'border-2 border-primary text-primary bg-transparent hover:bg-brand-50 dark:hover:bg-brand-900/10',
        destructive:
          'bg-destructive text-white shadow-xs hover:bg-destructive/90 focus-visible:ring-destructive/20 dark:focus-visible:ring-destructive/40 dark:bg-destructive/60',
        ghost:
          'hover:bg-surface-100 hover:text-surface-900 dark:hover:bg-surface-800',
